...
.text
    ...
    search_node:
        ...
        search_last_node_found:
            ...
            beq $t0, $zero, search_node_failure #caso não exista a flag, nao eh um noh terminal. Se for um noh terminal, a chave foi encontrada
            beq $t0, 1, search_node_sucess #caso exista a flag, é um noh terminal. Se for um noh terminal, a chave foi encontrada
