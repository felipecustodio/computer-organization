...
loop_exec1:	beq $a0, $t0, sai_loop	#16-04 enquanto $a0 < $t0 => farah 10 iteracoes   (desloca 3 palavras � frente)
...
sai_loop:	slt $t0, $a0, $t0 		#32-08 setando $t0 para zero  (como $a0==10 e $t0==10, entao $t0 = 0)
			...
			bne $t4, $t4, naopula	#52-13 nao efetiva o bne, pois $t4 == $t4  :-)    (desloca 3 palavras � frente)
...
277348355 0x10880003  [loop_exec1:] beq $4, $8, 16 (sai_loop-20)/4  ; 04: beq $a0, $t0, sai_loop #16-04 enquanto $a0 < $t0 => farah 10 iteracoes   (desloca 3 palavras � frente)
...
134217732 0x08000004  				j 0x00000004 (loop_exec1/4)     ; 07: j loop_exec1 		 	 #28-07 volta para inicio do loop (desloca 04 palavras para tr�s -04)
...
361496579 0x158c0003  				bne $12, $12, 16 (naopula-56)/4 ; 13: bne $t4, $t4, naopula	 #52-13 nao efetiva o bne, pois $t4 == $t4  :-)    (desloca 3 palavras � frente)
...
4294967295 0xffffffff				instru��o invalida             ; 23: instrucao invalida     #92-23 instrucao invalida 1111 1111 1111 1111 1111 1111 1111 1111 (0xffffffff)
